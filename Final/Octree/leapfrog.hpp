...
// * Leapfrog integrator
void leapFrog(vector<Particle>& particles, double size, double eps, double delta, double h, double time_end, unsigned int N, unsigned int write, string extension) {

    // * Declaring the files
    ofstream outfile_orbit(extension + "_Orbit.txt");
    ofstream outfile_energy(extension + "_EnergyError.txt");
    ...
    cout << endl;
    cout << "You simulated for " << time_end << " simulation units: the future is now!" << endl;
    cout << "======================================================================================================================================" << endl;

}

void PEFRL(vector<Particle>& particles, double size, double eps, double delta, double h, double time_end, unsigned int N, unsigned int write, string extension) {

    // * Declaring the files
    ofstream outfile_orbit(extension + "_PEFRL_Orbit.txt");
    ofstream outfile_energy(extension + "_PEFRL_EnergyError.txt");
    outfile_orbit << setprecision(12);
    outfile_energy << setprecision(12);
