Welcome to HEROIN (HiERarchical Octree sImulatioNs)!
...
Of interest for the user is the main.cpp file:
    ...
    -If you don't want the interface, directly go into the code and change the parameter values. You 	 also have to comment out the line of code containing "initialiser..."


Octree:
contains code for N-body simulations using the Newtonian equations of motion with use of the Barnes-Hut Algorithm in the monopole-quadrupole approximation
